        ...
        <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full mx-4">
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-xl font-bold text-gray-800">Xóa nhóm</h2>
                </div>

                {/* Content */}
                <p className="text-gray-600 mb-6">
                    Bạn có chắc chắn muốn xóa nhóm này? Hành động này không thể hoàn tác và tất cả dữ liệu sẽ bị mất.
                </p>

                {/* Buttons */}
                <div className="flex gap-3 justify-end">
                    <Link to={`/group/${id_group}/setting`}>
                        <button className="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                            Hủy
                        </button>
                    </Link>
                    <button
